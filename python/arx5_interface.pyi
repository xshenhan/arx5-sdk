...
class Arx5JointController:
    ...
    def set_joint_cmd(self, cmd: JointState, force_timestamp: bool = False) -> None: ...
    def set_joint_cmd_plan(self, cmd_plan: list[JointState]) -> None: ...
    ...
    def set_home_pose(self, home_joint_pos: npt.NDArray[np.float64]) -> None: ...
